...
person_tuple_list_test_() ->
	People = [{john, male, 1.8},{luke, male, 2.0},{jake, male, 2.4},{claire, female, 1.4},{jane, female, 1.2},{abby, female, 1.0},{michael, male, 2.2},{evyn, female, 1.6}], % TODO: Replace this with the list of tuples described in the previous comment
